...
> **本文所有 127 都是当日 Windows 通路上的实测值**，同日更晚的原生 Linux
> 第二/第三轮（doc/08 §11、§12）把套件涨到 130 例并改了六处引擎代码，
> **这四条 Windows 通路尚未在新代码上复跑**。也就是说本文的绿色描述的是
> 它当时那份源码；仓库当前状态的读数看 doc/08 §12.2。
